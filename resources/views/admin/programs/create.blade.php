<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white border border-slate-100 shadow-xl p-12 animate-fade-in-up">
            <form action="{{ route('admin.programs.store') }}" method="POST" class="space-y-8">
                @csrf

                <div class="grid grid-cols-2 gap-8">
                    <div>
                        <label class="block text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] mb-4">Institutional Code</label>
                        <input type="text" name="code" required placeholder="e.g., BS-CS-101"
                ...
                <div>
                    ...
                    <input type="text" name="name" required placeholder="e.g., Bachelor of Science in Computer Science"
                           class="w-full px-6 py-4 bg-slate-50 border border-slate-100 focus:border-[#2B579A] focus:bg-white outline-none transition-all text-sm font-bold">
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="6" required placeholder="Describe the core objectives and outcomes..."
                ...
                <div class="pt-8 flex justify-end gap-6">
                    <a href="{{ route('admin.programs.index') }}" class="px-8 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-slate-600 transition-colors">Cancel</a>
