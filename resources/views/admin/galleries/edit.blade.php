    ...
    <div class="animate-fade-in-up">
        <div class="max-w-2xl mx-auto">
            <div class="bg-white shadow rounded-lg">
                <form action="{{ route('admin.galleries.update', $gallery) }}" method="POST" enctype="multipart/form-data" class="space-y-3">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="px-4 space-y-3">
                            ...
                            <div class="border border-gray-200 rounded-lg p-2">
                                ...
                                @elseif($gallery->type === 'video')
                                    <div class="text-center">
                                        ...
                                        <p class="text-xs text-gray-600">Video: {{ basename($gallery->file_path) }}</p>
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="description" 
                                      ...
                                      rows="2"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                                      placeholder="Enter a brief description (optional)">{{ old('description', $gallery->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-3 text-center hover:border-gray-400 transition-colors">
                                <div class="space-y-1">
                                    ...
                                    <p class="text-xs text-gray-500">
                                        Leave empty to keep current file. New file: PNG, JPG, GIF up to 10MB or MP4, MOV, AVI up to 10MB
                                    </p>
                                    <input type="file" 
                                           id="file" 
                                           name="file" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <select id="category" 
                                    ...
                                    <option value="campus-life" {{ old('category', $gallery->category) == 'campus-life' ? 'selected' : '' }}>Campus Life</option>
                                    ...
                                    <option value="academic" {{ old('category', $gallery->category) == 'academic' ? 'selected' : '' }}>Academic</option>
