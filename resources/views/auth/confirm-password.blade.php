    ...
    <div class="min-h-screen flex items-center justify-center p-6 bg-cover bg-center relative" style="background-image: url('https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=2000');">
        ...
        <div class="relative z-10 w-full max-w-[450px] bg-white shadow-2xl overflow-hidden animate-fade-in-up">
            ...
            <div class="bg-[#1a3a63] p-12 text-center border-b-8 border-[#FDB913]">
                ...
                <h2 class="text-white text-xs font-black uppercase tracking-[0.3em] mb-2">Security Verification</h2>
                <h1 class="text-white text-xl font-serif font-black leading-tight">Confirm Your Password</h1>
            </div>
            ...
            <div class="p-12">
                ...
                <form method="POST" action="{{ route('password.confirm') }}" class="space-y-8">
                    ...
                    <!-- Password -->
                    <div>
                        <label for="password" class="block text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3">Current Password</label>
                    ...
                    <div class="text-center pt-4">
                        <a href="{{ route('dashboard') }}" class="text-[10px] font-black text-[#2B579A] uppercase tracking-widest hover:text-black transition-colors">
                            Back to Dashboard
                        </a>
                    </div>
                </form>
                ...
                <div class="mt-12 text-center pt-8 border-t border-slate-50">
                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-loose">
                        SECURITY VERIFICATION ACTIVE. <br> PROTECTED BY SJUT SECURITY SYSTEMS.
                    </p>
                </div>
            </div>
        </div>
