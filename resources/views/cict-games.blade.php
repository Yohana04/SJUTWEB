    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                Engage, learn, and compete through our innovative gaming initiatives and e-sports programs at CICT.
            </p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-12 text-center">
            ...
            <p class="text-slate-600 mb-8">
                This section is under development. Check back soon for gaming tournaments, e-sports events, and interactive learning games.
            </p>
